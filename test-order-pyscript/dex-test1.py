...
def oracle_fake(derivative_price):
    derivative_price += int(random.random()*10 - 5)
    ...
    for i in range(0,10):
        orderbook.append(
            ...
            "id": 8799190000,
            "side": "Sell",
            "size": int(random.random()*1000),
            "price": derivative_price + i
            },
        )
    for i in range(0,10):
        orderbook.append(
